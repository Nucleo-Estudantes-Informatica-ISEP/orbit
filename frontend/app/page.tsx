          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card className="bg-background shadow-none hover:border-primary/50 transition-colors duration-300">
              <CardHeader>
                ...
                <CardDescription>{t('home.recruitmentDescription')}</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-background shadow-none hover:border-primary/50 transition-colors duration-300">
              <CardHeader>
                ...
                <CardDescription>{t('home.tasksDescription')}</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-background shadow-none hover:border-primary/50 transition-colors duration-300">
              <CardHeader>
                ...
                <CardDescription>{t('home.rbacDescription')}</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-background shadow-none hover:border-primary/50 transition-colors duration-300">
              <CardHeader>
                ...
                <CardDescription>{t('home.feedDescription')}</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-background shadow-none hover:border-primary/50 transition-colors duration-300">
              <CardHeader>
                ...
                <CardDescription>{t('home.eventsDescription')}</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-background shadow-none hover:border-primary/50 transition-colors duration-300">
              <CardHeader>
                ...
                <CardDescription>{t('home.notificationsDescription')}</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </section>
