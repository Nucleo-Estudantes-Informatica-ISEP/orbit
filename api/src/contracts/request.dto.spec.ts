...
describe('request DTO contracts', () => {
  it.each([
    ...
    [
      CreateProjectDto,
      { name: 'Project', departmentId: '1d813fc8-229d-4f66-83ad-72fd7d5b1254' },
    ],
    ...
    const instance = plainToInstance(Dto as ClassConstructor<object>, payload);
  ...
  it.each([
    ...
    [
      CreateAnnouncementDto,
      { title: 'Update', content: 'Valid', description: '' },
    ],
    [
      CreateEventDto,
      {
    ...
    [
      CreateEventDto,
      { title: 'Meeting', end: '2026-08-06T11:00:00.000Z', endDate: 'invalid' },
    ],
